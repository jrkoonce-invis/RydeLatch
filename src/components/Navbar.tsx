    ...
    >
      ...
      <div className={cn(
        ...
        <nav className="flex flex-col px-6 py-8 bg-white flex-grow overflow-y-auto">
          ...
          <a 
            href="#mission" 
            className="text-lg font-medium py-4 border-b border-gray-100 flex items-center justify-between hover:text-ryde-500" 
            onClick={() => {
              setIsMenuOpen(false);
              document.body.style.overflow = '';
            }}
        ...
        <div className="mt-auto p-6 border-t border-gray-100 bg-white">
          <p className="text-sm text-gray-500">
            © 2025 Rydelatch. All rights reserved.
          </p>
        </div>
      </div>
    </header>
