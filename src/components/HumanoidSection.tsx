      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4">
              <div className="pulse-chip opacity-0 animate-fade-in" style={{
                ...
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-ryde-500 text-white mr-2">02</span>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-ryde-900/40 to-dark-900/80"
                style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg leading-relaxed">
                    Our mission at Rydelatch is simple: we're here to make campus biking safer and more convenient by bringing smart lock technology right to universities.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We want everyone to feel confident that their bikes are secure
                  </h3>
                  <p className="text-white/90 text-lg leading-relaxed">
                    Letting them focus on their day without worry, knowing their transportation is protected.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Campus Pride</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're proud to be a <span className="text-[#22c55e]">student-led team</span>
                  </h3>
                  <p className="text-white/90 text-lg leading-relaxed">
                    Building something that makes our own campus a better place, embracing creativity and clever solutions.
                  </p>
                </div>
              </div>
            </div>
